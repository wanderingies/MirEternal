...
namespace PcapEditor.Windows.Forms
{
    /// <summary>
    ...
    public class HexBox : Control
    {
        ...
        class KeyInterpreter : IKeyInterpreter
        {
            ...
            public virtual bool PreProcessWmChar(ref Message m)
            {
                ...
                if (Uri.IsHexDigit(c))
                {
                    ...
                    byte newcb = byte.Parse(sNewCb, System.Globalization.NumberStyles.AllowHexSpecifier, Thread.CurrentThread.CurrentCulture);
        ...
        {
            bool isByte = byte.TryParse(hex, System.Globalization.NumberStyles.HexNumber, Thread.CurrentThread.CurrentCulture, out b);
            return isByte;
        }
