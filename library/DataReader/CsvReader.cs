...
using DataReader.TypeConversion;
using System.Linq;
using System.Reflection;
using System.Threading.Tasks;
using DataReader.Expressions;
...
namespace DataReader
{
	...
	public class CsvReader : IReader
	{
		...
		/// <see cref="DataReader.Configuration.CsvConfiguration" /> and <see cref="CsvParser" /> as the default parser.
		/// </summary>
		/// <param name="reader">The reader.</param>
